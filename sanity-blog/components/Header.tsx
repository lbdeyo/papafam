...
function Header() {
  return (
    <header className="  navigationBar  font-bold px-5 md:px-10 pt-1  pb-2  border-zinc-400  shadow-sm dark:shadow-lg   fixed z-50 top-0 left-0 right-0 bg-[#fafafa] bg-opacity-90    dark:bg-[#262629] dark:border-zinc-700">
