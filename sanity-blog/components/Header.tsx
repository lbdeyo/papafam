...
function Header() {
  return (
    <header className=" flex navigationBar  items-center justify-between space-x-0 md:space-x-2 font-bold px-5 md:px-10 pt-1  pb-2  border-zinc-400 border-b-2 shadow-lg  fixed z-50 top-0 left-0 right-0 bg-gradient-to-r from-zinc-300 via-zinc-200  to-zinc-300 to-80%    dark:border-black dark:bg-gradient-to-r dark:from-zinc-900  dark:via-zinc-800  dark:to-zinc-900 ">
